  ...
  return (
    <div className="flex flex-col items-center justify-center md:pt-25 md:pb-28 py-16 max-w-screen-2xl text-center md:gap-14">
      <div className="p-2 text-button-yellow">
        ...
        <h3 className="text-hover-button font-bold text-lg p-2">
          Welcome to Recipe Finder!
        </h3>
        <p className="lg:px-44 text-yellow-300 lg:text-xl md:text-md  font-semibold">
      ...
      <div className="p-2 text-button-yellow">
        ...
        <h4 className="text-hover-button font-bold text-md p-2">
          Our mission is simple
        </h4>
        <p className="lg:px-44 text-yellow-300 lg:text-xl md:text-md font-semibold text-md">
